...
**`Ctrl`/`⌘`+`Z` undoes the last thing that moved a window** — a drag, whatever it pushed, a group, a
tidy. Not inside a terminal: there it belongs to whatever is running.
